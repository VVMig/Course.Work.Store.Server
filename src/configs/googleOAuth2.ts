...
const oauth2Client = new google.auth.OAuth2({
    ...
    redirectUri: process.env.SERVER_URL ? `${process.env.SERVER_URL}${ApiRoutes.USER}${Routes.USER_GMAIL_AUTH_CALLBACK}` : 'http://localhost:3000/api/user/gmailAuthCallback'
});
